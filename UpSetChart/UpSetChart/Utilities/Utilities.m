...
OneElementInAnyComparisonsQ::usage="";
EmptySetsQ::usage="";
...
OneElementInAnyComparisonsQ[comparisons_Association]:= Max[Length /@ Values@comparisons] > 0
EmptySetsQ[sets_?LabeledSetsQ]:= MemberQ[Length/@Values@sets,0]
