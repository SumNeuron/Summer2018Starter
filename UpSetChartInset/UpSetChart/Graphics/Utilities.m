...
NumberOfTicks::usage=StringJoin[
  "NumberOfTicks[maxValue, numberOfTicks, 'ReversedQ'->True/False]"
];
...
Module[
  ...
  sL  = SetsLabels[setsNames,
    ...
    "IndicatorRadius" -> OptionValue["IndicatorRadius"],
    "IndicatorSpacing" -> OptionValue["IndicatorSpacing"]
    (* , "InsetPosition"->{maxSetCardinality + 2 First@OptionValue["ComponentSpacing"], 0} *)
    (* , "InsetOffsetPosition"->{maxSetCardinality + 2 First@OptionValue["ComponentSpacing"], 0} *)
